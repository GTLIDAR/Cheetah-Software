...
#ifndef CHEETAH_SOFTWARE_ROBOTRUNNER_SIM_H
#define CHEETAH_SOFTWARE_ROBOTRUNNER_SIM_H
...
class RobotRunner_sim : public PeriodicTask {
public:
    EIGEN_MAKE_ALIGNED_OPERATOR_NEW

    RobotRunner_sim(RobotController* , PeriodicTaskManager*, float, std::string);
...
#endif //CHEETAH_SOFTWARE_ROBOTRUNNER_SIM_H
